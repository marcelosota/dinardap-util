 ...
 */
package ec.gob.dinardap.persistence.constante;
...
public enum CriteriaTypeEnum {
	...
	/* numericos */
	LONG_EQUALS, LONG_NOT_EQUALS, LONG_IS_NULL, INTEGER_EQUALS, INTEGER_NOT_EQUALS, INTEGER_IS_NULL, DOUBLE_EQUALS, DOUBLE_NOT_EQUALS, SHORT_EQUALS, SHORT_NOT_EQUALS,
	/* booelan */
	BOOLEAN_POSTGRESQL,
	/* fecha */
	DATE_BETWEEN;
